...
def gen_constraint_col_d(game: list):
    """Converts 2D list holding game in std format
     to CNF in DIMACS format for col definedness constraint.
...
if __name__ == '__main__':
    """Tests for constraint: col definedness.
    """
    path = '../data/p096_sudoku.txt'
    grids = parse(path)
    game = grids[1]
    print(gen_constraint_col_d(game))